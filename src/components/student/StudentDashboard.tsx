...
export function StudentDashboard({ activeSubTab, setActiveSubTab }: StudentDashboardProps) {
  ...
  return (
    <div className="w-full space-y-8 animate-fadeIn text-left">
      ...
      <Card className="relative rounded-xl border border-slate-200 dark:border-zinc-800/80 bg-white/80 dark:bg-zinc-900/30 backdrop-blur-md overflow-hidden shadow-sm dark:shadow-none">
        <div className="absolute top-0 right-0 w-64 h-64 bg-indigo-500/10 rounded-full blur-[80px] pointer-events-none" />

        <CardContent className="p-6 md:p-8 flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10 w-full">
          <div className="flex items-center gap-5">
            <div className="relative shrink-0">
              <img
                ...
                className="w-16 h-16 md:w-20 md:h-20 rounded-full border border-indigo-500/30 object-cover shadow-lg shadow-indigo-500/10"
              />
            ...
            <div>
              <div className="flex flex-wrap items-center gap-2.5 mb-1">
                ...
                <span className={`px-2.5 py-0.5 rounded text-[10px] font-bold uppercase tracking-wider ${student.status === 'Grant' ? 'bg-emerald-500/10 border border-emerald-500/20 text-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.1)]' : 'bg-amber-500/10 border border-amber-500/20 text-amber-500'}`}>
                  {student.status}
                </span>
              </div>
              <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Guruh: <strong className="text-indigo-500 dark:text-indigo-400 font-bold">{student.group}</strong> | ID: {student.id}</p>
              <div className="flex flex-wrap gap-4 mt-3 text-xs text-slate-500 dark:text-slate-400">
                ...
                <span>•</span>
                <span>Yakuniy Reyting: <strong className="text-indigo-500 dark:text-indigo-400 font-extrabold">{student.finalScore} / 110.0</strong></span>
              </div>
            </div>
          </div>

          {/* Quick Stats Grid inside profile */}
          <div className="flex gap-8 bg-slate-50/80 dark:bg-zinc-950/40 p-4 rounded-xl border border-slate-200 dark:border-zinc-800/60 shadow-inner">
            <div className="text-center px-2">
              <span className="text-[10px] text-slate-500 block font-bold uppercase tracking-widest mb-1">GPA</span>
              <span className="text-lg font-black text-slate-800 dark:text-white">{student.gpa}%</span>
            </div>
            <div className="w-px bg-slate-200 dark:bg-zinc-800/60" />
            <div className="text-center px-2">
              <span className="text-[10px] text-slate-500 block font-bold uppercase tracking-widest mb-1">Davomat</span>
              <span className="text-lg font-black text-emerald-500 dark:text-emerald-400">{student.attendance_summary.attendance_percentage}%</span>
            </div>
          </div>
        </CardContent>
      </Card>
                  ...
                  <div className="relative w-20 h-20 flex items-center justify-center">
                    <svg className="w-full h-full transform -rotate-90">
                      ...
                      <circle
                        ...
                        cy="40"
                        r="32"
                        className={`stroke-5 fill-none ${student.attendance_summary.attendance_percentage < 80
            ...
            <Card className="bg-white/80 dark:bg-zinc-900/50 backdrop-blur-md border-slate-200 dark:border-zinc-800 shadow-sm dark:shadow-none">
              ...
              <CardContent className="pt-6 space-y-3.5">
                {student.subjects.map(sub => (
                  <Card key={sub.subject_id} className="flex justify-between items-center p-3 rounded-lg bg-slate-50 dark:bg-zinc-950/30 border border-slate-200 dark:border-zinc-800/50 hover:border-slate-300 dark:hover:border-zinc-700 transition-colors shadow-sm dark:shadow-none">
                    <div>
              ...
              <CardContent className="pt-6 space-y-4">
                ...
                <div className="space-y-1">
                  ...
                  <div className="h-2 w-full rounded-full bg-slate-100 dark:bg-zinc-950 border border-slate-200 dark:border-zinc-850 overflow-hidden">
                    <div
                      className="h-full rounded-full bg-linear-to-r from-indigo-500 to-purple-500 shadow-[0_0_8px_rgba(99,102,241,0.4)]"
                ...
                <div className="space-y-1">
                  ...
                  <div className="h-2 w-full rounded-full bg-slate-100 dark:bg-zinc-950 border border-slate-200 dark:border-zinc-850 overflow-hidden">
                    <div
                      className="h-full rounded-full bg-linear-to-r from-purple-500 to-pink-500 shadow-[0_0_8px_rgba(168,85,247,0.4)]"
                ...
                <div className="space-y-1">
                  ...
                  <div className="h-2 w-full rounded-full bg-slate-100 dark:bg-zinc-950 border border-slate-200 dark:border-zinc-850 overflow-hidden">
                    <div
                      className="h-full rounded-full bg-linear-to-r from-pink-500 to-rose-500 shadow-[0_0_8px_rgba(236,72,153,0.4)]"
                ...
                <div className="space-y-1">
                  ...
                  <div className="h-2 w-full rounded-full bg-slate-100 dark:bg-zinc-950 border border-slate-200 dark:border-zinc-850 overflow-hidden">
                    <div
                      className="h-full rounded-full bg-linear-to-r from-emerald-500 to-teal-500 shadow-[0_0_8px_rgba(16,185,129,0.4)]"
                ...
                <div className="space-y-1">
                  ...
                  <div className="h-2 w-full rounded-full bg-slate-100 dark:bg-zinc-950 border border-slate-200 dark:border-zinc-850 overflow-hidden">
                    <div
                      className="h-full rounded-full bg-linear-to-r from-teal-500 to-sky-500 shadow-[0_0_8px_rgba(20,184,166,0.4)]"
                ...
                <div className="space-y-1">
                  ...
                  <div className="h-2 w-full rounded-full bg-slate-100 dark:bg-zinc-950 border border-slate-200 dark:border-zinc-850 overflow-hidden">
                    <div
                      className="h-full rounded-full bg-linear-to-r from-sky-500 to-indigo-500 shadow-[0_0_8px_rgba(14,165,233,0.4)]"
        ...
        <div className="space-y-8 animate-fadeIn">
          <Card className="bg-white/80 dark:bg-zinc-900/50 backdrop-blur-md border-slate-200 dark:border-zinc-800 shadow-sm dark:shadow-none">
            <CardHeader className="pb-0">
              <CardTitle className="text-lg font-black text-slate-900 dark:text-white">Fanlar va Amaliy Topshiriqlar</CardTitle>
              <CardDescription className="text-xs text-slate-500 dark:text-slate-400">Joriy davomat foizlari, o'quv resurslari hamda amaliy topshiriqlarni baholash monitoringi.</CardDescription>
            </CardHeader>
          </Card>
          ...
          {student.subjects.map(sub => {
            ...
            return (
              <Card key={sub.subject_id} className="bg-white/80 dark:bg-zinc-900/50 backdrop-blur-md border-slate-200 dark:border-zinc-800/80 shadow-sm dark:shadow-none">
                <CardHeader className="border-b border-slate-200 dark:border-zinc-850/40">
                  <div className="flex justify-between items-start w-full">
                    <div>
                      <CardTitle className="text-base font-black text-slate-900 dark:text-white">{sub.subject_name}</CardTitle>
                      <CardDescription className="text-sm text-slate-500 dark:text-slate-400">Mentor: <strong className="text-slate-800 dark:text-slate-200 font-semibold">{sub.teacher}</strong> | Davomatingiz: <strong className="text-indigo-600 dark:text-indigo-400 font-black">{sub.subject_summary.percentage}%</strong></CardDescription>
                    </div>
                  ...
                  <div className="w-full">
                    ...
                    <div className="space-y-3.5">
                      {relatedAssignments.map(asn => (
                        <Card key={asn.id} className="p-4 rounded-lg bg-slate-50/50 dark:bg-zinc-950/30 border border-slate-200 dark:border-zinc-800/60 flex flex-col sm:flex-row justify-between sm:items-center gap-4 shadow-sm dark:shadow-none">
                          <div>
                            <div className="flex items-center gap-2 mb-1.5">
                              <h6 className="text-sm font-black text-slate-900 dark:text-white">{asn.title}</h6>
                              <span className={`px-2 py-0.5 rounded text-[10px] font-extrabold uppercase ${asn.status === 'Topshirilgan' ? 'bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border border-emerald-500/20' :
              ...
              <CardContent className="pt-6 space-y-4">
                {student.achievements.length === 0 ? (
                  ...
                  student.achievements.map(ach => (
                    <Card key={ach.id} className="p-4 rounded-lg bg-slate-50/50 dark:bg-zinc-950/30 border border-slate-200 dark:border-zinc-800/60 hover:border-slate-300 dark:hover:border-zinc-700 transition-colors space-y-3 shadow-sm dark:shadow-none">
                      <div className="flex justify-between items-start gap-4">
                        <div>
                          <div className="flex items-center gap-2 flex-wrap">
                            <h4 className="text-xs font-black text-slate-900 dark:text-white">{ach.title}</h4>
                            <span className={`px-2 py-0.5 rounded text-[8px] font-extrabold uppercase ${ach.status === 'Tasdiqlandi' ? 'bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border border-emerald-500/20' :
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="py-3.5 px-4 text-center">
                          <span className={`px-2 py-0.5 rounded text-[9px] font-black ${st.riskLevel === 'High' ? 'bg-rose-500/10 text-rose-600 dark:text-rose-400 border border-rose-500/20' :
            ...
            <div className="space-y-4">
              {student.feedback.length === 0 ? (
                ...
                student.feedback.map(fb => (
                  <Card key={fb.id} className="p-4 rounded-lg bg-slate-50/50 dark:bg-zinc-950/30 border border-slate-200 dark:border-zinc-800/60 hover:border-slate-300 dark:hover:border-zinc-700 transition-colors space-y-2.5 shadow-sm dark:shadow-none">
                    <div className="flex justify-between items-start flex-wrap gap-2">
                      ...
                      <span className={`px-2 py-0.5 rounded text-[8px] font-extrabold uppercase ${fb.type === 'Academic' ? 'bg-indigo-500/10 text-indigo-600 dark:text-indigo-400' :
